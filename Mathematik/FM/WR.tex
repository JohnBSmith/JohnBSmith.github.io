...
den Einzelwahrscheinlichkeiten induzierte) \emdef{Wahrscheinlichkeitsmaß}.
...
\minisection\strong{Mehrstufige Experimente.}
...
\minisection\strong{Erste Pfadregel.}
...
\minisection\strong{Zweite Pfadregel.}
...
\minisection\strong{Satz von Bayes.}
...
X\colon\Omega\to\R
\end{equation}
heißt \emdef{Zufallsgröße}. Die Funktionswerte $x=X(\omega)$ heißen
\emdef{Realisationen} der Zufallsgröße.
\end{definition}
...
\section{Allgemeine Verteilungen}

\noindent\strong{Gesetz der totalen Wahrscheinlichkeit.}
