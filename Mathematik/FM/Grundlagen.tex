...
&& \Phi(z^{-1}) = \Phi(z)^{-1},\\
& |z|^2 = \det(\Phi(z)), && \Phi(\ee^z) = \exp(\Phi(z)).
\end{align}
...
\subsubsection{Natürliches Schließen}
\begin{tabular}{@{}llll}
$\displaystyle\frac{A,\;B}{A\land B}$ &
$\displaystyle\frac{A\land B}{A}$ &
$\displaystyle\frac{A}{A\lor B}$ &
$\displaystyle\frac{A\lor B,\;\; A\vdash C,\;\; B\vdash C}{C}$
\end{tabular}\\[10pt]
\begin{tabular}{@{}llll}
$\displaystyle\frac{A\vdash B}{A\to B}$ &
$\displaystyle\frac{A,\;\;A\to B}{B}$ &
$\displaystyle\frac{A\vdash 0}{\neg A}$ &
$\displaystyle\frac{\neg\neg A}{A}$
\end{tabular}\\[10pt]
\begin{tabular}{@{}llll}
$\displaystyle\frac{A(u)}{\forall x\colon A(x)}$ &
$\displaystyle\frac{\forall x\colon A(x)}{A(t)}$ &
$\displaystyle\frac{A(t)}{\exists x\colon A(x)}$ &
$\displaystyle\frac{\exists x\colon A(x),\;A(u)\vdash B}{B}$
\end{tabular}
