...
\end{array}
\]
Programmterm zu $(A\Rightarrow B)\Rightarrow (B\Rightarrow 0)\Rightarrow (A\Rightarrow 0)$:
...
\end{array}
\]
Vermittels $\operatorname{dn}(A)\colon ((A\mapsto 0)\mapsto 0)\mapsto A$
