...
\begin{Satz}[Deduktionstheorem für Sequenzen]\label{sequent-dt}\newlinefirst
...
\begin{Satz}[Modus tollendo ponens]
...
\begin{Satz}[Klassische Reductio ad absurdum] \strong{[LEM]}\\
Es gilt die Schlussregel
...
\equiv \neg\neg B\lor\neg A \equiv \neg B\Rightarrow \neg A.\,\qedsymbol\]
\end{Beweis}
\begin{Beweis}[Beweis 2 (LEM, natürliches Schließen)]
...
\begin{Definition}[set-diff: Differenz]%
