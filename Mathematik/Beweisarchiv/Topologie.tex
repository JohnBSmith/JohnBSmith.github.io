...
\begin{Definition}[Topologischer Raum]\index{topologischer Raum}
...
\begin{Definition}[Rand]\index{Rand}
...
\index{Homoeomorphismus@Homöomorphismus}\newlinefirst
...
besitzen disjunkte Epsilon-Umgebungen]\label{uneq-points-disjoint-ep-balls}
