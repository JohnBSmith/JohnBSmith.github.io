...
\begin{Definition}[Teiler]\index{Teiler}
Für $a,m\in\Z$ ist die Relation »$m$ teilt
$a$« definiert als
\[m\mid a\defiff \exists k\in\Z\colon a = km.\]
\end{Definition}

\begin{Definition}[Kongruenz]\label{def:cong}\index{Kongruenz}
...
\begin{Definition}[Teilermenge]\index{Teilermenge}
...
\begin{Definition}[Teilerfunktion]\index{Teilerfunktion}\newlinefirst
...
\begin{Definition}[Primzahl]\index{Primzahl}\newlinefirst
...
\begin{Satz}[Satz des Euklid]\index{Satz des Euklid}\index{Euklid, Satz des}
