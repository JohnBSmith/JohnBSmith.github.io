...
\[D(\eta_p(f))(x) = (D\circ\eta_p)(f)(x) = Y(f(x),F(D)(f)(x))\]
...
= Y(F(C_\gamma)(f)(0),F(D)(F(C_\gamma)(f))(0))\\
= Y(f(x),F(D\circ C_\gamma)(f)(0))
= Y(f(x),F(D_v)(f)(x)).\;\qedsymbol
\end{gather*}
\end{Beweis}
...
\begin{gather*}
\begin{array}{ll}
p(y_1,y_2) = y_1+y_2, & Y((y_1,y_2),(y_1',y_2')) = y_1'+y_2',\\[4pt]
p(y_1,y_2) = y_1 y_2, & Y((y_1,y_2),(y_1',y_2')) = y_1'y_2 + y_1y_2',\\[4pt]
p(y) = cy, & Y(y,y') = cy',\\[4pt]
p(y) = g(y), & Y(y,y') = g'(y)y'.
\end{array}
\end{gather*}
