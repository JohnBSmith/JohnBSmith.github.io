...
Aktualisierung vermittelt der Faktor $\beta_P(E,H)$ mit
\[P(H\mid E) = \beta_P(E,H)P(H).\]
Nämlich geht dies gemäß dem Satz von Bayes auf, wobei wir
\[\beta_P(E,H) := \frac{P(E\mid H)}{P(E)} = \frac{P(E\cap H)}{P(E)P(H)}\]
erhalten.

Im zuvor diskutierten Beispiel zur Beurteilung diagnostischer Tests
war $H:=K$ die Hypothese und $E:=T^+$ die Evidenz.
