...
\end{Satz}
\begin{Beweis}
Die rechte Seite gelte. Dann liegt ein $u$ mit $A(u)$
...
Die linke Seite gelte. Dann liegt ein $u$ mit $A(u)$ vor. Wir wählen
...
beim ersten Lesen überspringen. Zunächst sollte er sich durch das
Kapitel zur Mengenlehre durcharbeiten, insbesondere auch durch den
Abschnitt zu den Halbordnungen.

Einige Autoren halten es für richtig, ein Buch linear zu schreiben, so
dass alle benötigten Begriffe und Sätze bereits bei der Erklärung neuer
Sachverhalte zur Verfügung stehen. Aber ich denke, man kann ein Buch
auch nichtlinear formulieren, solange man das ordentlich macht. In jedem
guten Spiel kommt doch irgendwo auch mal einen zunächst unzugänglicher
Ort vor, an dessen Zugang man später noch einmal zurückkehren muss.
...
liefert wie gesagt die natürlichen Zahl via $\bigcap\setsystem A = \N$.

Es zeigt sich wieder, ass $\bigcap\setsystem A$ die kleinste
