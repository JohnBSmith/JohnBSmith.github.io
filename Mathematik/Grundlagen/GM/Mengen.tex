...
Sofern zu einer vorgelegte Aussageform $A(x)$ nicht nur ein diese
...
Existenz eines $y\in B$ mit $(x,y)\in f$. Kommt mehrere Applikationen
...
Applikation einschließlich der arithmetische Operationen durch eine
Existenzaussage kodieren. Auf diese Weise ließe sich aber die
Gleichheit aus der Logik herausarbieten.
