...
% [todo] Sie wird zum beweisen benutzt. Man zeigt
% $x\in A\cond x\in B$ und $x\in B\cond x\in A$,
% für festes, aber beliebiges $x$. Und damit ist bereits klar,
% dass $A = B$ sein muss.
...
Cantors Diagonalargument weiter Art. Man definiert dafür die Folge
