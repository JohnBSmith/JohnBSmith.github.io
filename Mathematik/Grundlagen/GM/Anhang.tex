...
& $(A\land B\cond C)\cond (A\cond (B\cond C))$\\[14pt]
\begin{tabular}{@{}c@{}}Umkehrung der\\ Exportation\end{tabular}
& $\dfrac{\Gamma\vdash A\cond (B\cond C)}{\Gamma\vdash A\land B\cond C}$
& $(A\cond (B\cond C))\cond (A\land B\cond C)$\\[14pt]
Absorption
& $\dfrac{\Gamma\vdash A\cond B}{\Gamma\vdash A\cond A\land B}$
& $(A\cond B)\bicond (A\cond A\land B)$\\[14pt]
Abschwächung
& $\dfrac{\Gamma\vdash B}{\Gamma, A\vdash B}$
& $B\cond (A\cond B)$\\[14pt]
Ersetzungsregel
