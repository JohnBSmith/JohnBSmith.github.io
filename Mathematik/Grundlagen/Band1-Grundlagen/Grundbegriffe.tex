...
(\text{$\overline A$ ist hinreichend für $\overline B$}).\]
...
\begin{Satz}[Reductio ad absurdum]
...
\begin{Satz}[Bildmenge unter Verkettungen]\label{img-comp}
...
\begin{Definition}[Injektive Abbidlung]
...
\begin{Definition}[Surjektive Abbildung]
...
\begin{Definition}[Bijektive Abbildung]
