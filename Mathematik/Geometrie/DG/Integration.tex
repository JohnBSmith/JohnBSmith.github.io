...
\emph{Spat}\index{Spat} oder \emph{Parallelepiped}. Die
Verallgemeinerung dieses Begriffs auf eine beliebige Dimension wollen
wir als \emph{Parallelotop}\index{Parallelotop}
...
\emph{Multivektoren}\index{Multivektor} genannt werden. Ein
\emph{Blade}\index{Blade} ist ein Multivektor der Form
...
\emph{gramsche Determinante}\index{gramsche Determinante}
zur Matrix $A$.
