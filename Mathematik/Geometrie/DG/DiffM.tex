...
Anfangswertproblem\index{Anfangswertproblem}
\begin{equation}
...
Nebenbedingung\index{Nebenbedingung} $g(x,y)=0$
eingeschränkt wird. Laut dem Verfahren der lagrangeschen
Multiplikatoren\index{lagrangesche Multiplikatoren}
ist die Gleichung $\nabla f = \lambda\nabla g$
...
Sei $M$ eine differenzierbare Mannigfaltigkeit und $(x_i)$ eine
