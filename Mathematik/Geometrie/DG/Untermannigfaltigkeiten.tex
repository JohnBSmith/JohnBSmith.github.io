...
$g=g({ij})$ mit $g_{ij}:=B(g_i,g_j)$ dann als \emph{gramsche Matrix}
...
$\det\ge 0$ kann $0$ bei uns nicht auftreten, der Trägheitsindex von
$B$ ist also $(p,q,0)$.
...
man das orthogonale Komplement von $U$ bezüglich $B$ als
\begin{equation}
...
$u\in\{g_k\}$ erfüllt ist, anstellen für alle $u\in U$. Einsetzen
ergibt nun
\begin{equation}
...
\begin{definition}[Topologische Untermannigfaltigkeit]\mbox{}\\*
