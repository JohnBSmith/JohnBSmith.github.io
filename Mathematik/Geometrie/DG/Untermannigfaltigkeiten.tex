...
Weil eine riemannsche Metrik jedem Punkt ein Skalarprodukt zuordnet,
...
\end{corollary}
\strong{Beweis.} Ist $J$ konform, ergibt sich
\begin{equation}
...
\end{corollary}
\strong{Beweis.} Gemäß der Prämisse besitzt $f$ am Punkt $p$
...
Die Analogie zur komplexen Funktion $z\mapsto z^2$ ist kein Zufall.
...
\end{corollary}
\strong{Beweis.} Es gelte die rechte Seite der Äquivalenz. Dann ist
...
\end{equation}
als lineare Abbildung dargestellt werden kann. Diese ist konform, denn
\begin{align}
