...
\begin{definition}[Affine Koordinatentransformation]\mbox{}\\*
...
\begin{definition}[Parameterkurve, Kurve]\mbox{}\\*
...
\begin{definition}[Geschlossener Weg]\mbox{}\\*
...
\begin{definition}[Reguläre Parameterkurve]\mbox{}\\*
...
\begin{definition}[Umparametrisierung, Parametertransformation]\mbox{}\\*
...
\begin{definition}[Orientierte Kurve]\mbox{}\\*
...
\begin{definition}[Länge, rektifizierbarer Weg]\mbox{}\\*
...
\begin{definition}[Kurvenintegral eines Skalarfeldes]\mbox{}\\*
...
\begin{definition}[Begleitendes Dreibein]\mbox{}\\*
...
\begin{theorem}[Frenetsche Formeln für räumliche Kurven]\mbox{}\\*
...
Liegt eine ebene Kurve $c\colon[a,b]\to\R^2$ vor, kann man sich
...
\begin{equation}
K_c := \int_a^b K(c,s)\,\mathrm ds.
\end{equation}
\end{definition}
Aus der Totalkrümmung ergibt sich die Tangentenumlaufzahl
$K_c/(2\pi)$, die, wie sich herausstellen wird, eine topologische
