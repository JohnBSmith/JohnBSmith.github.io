...
\begin{definition}[Krümmung einer Parameterkurve]
...
\begin{theorem}[Berechnungsformel für die Krümmung]
Sei $\gamma\colon I\to\R^n$ eine reguläre zweimal stetig
...
\begin{definition}[Begleitendes Zweibein]
...
\begin{theorem}[Frenetsche Formeln für ebene Kurven]
...
\begin{align}
T(s) &:= \gamma'(s), && \text{(\emph{Tangenteneinheitsvektor})}\\
N(s) &:= \frac{\gamma''(s)}{|\gamma''(s)|}, && \text{(\emph{Hauptnormaleneinheitsvektor})}\\
