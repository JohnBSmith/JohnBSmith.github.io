...
\begin{equation}
\operatorname{Eig}(A,\lambda):=\{v\mid Av=\lambda v\}.
\end{equation}
Die Dimension $\dim\operatorname{Eig}(A,\lambda)$ wird
...
Lösungskriterium:
\begin{equation}
\exists x[Ax=b] \iff \operatorname{rg}(A)=\operatorname{rg}(A\,|\,b).
\end{equation}
Eindeutige Lösung (bei $n$ Unbekannten):
\begin{equation}
\exists! x[Ax=b] \iff\operatorname{rg}(A)=\operatorname{rg}(A\,|\,b)=n.
\end{equation}
Im Fall $m=n$ gilt:
\begin{equation}
\begin{split}
&\exists! x[Ax=b] \iff A\in\operatorname{GL}(n,K)\\
&\iff \operatorname{rg}(A)=n \iff \det(A)\ne 0.
\end{split}
\end{equation}
