...
$\mathbb K$-Vektorraum $V$ in die nichtnegativen reellen Zahlen heißt
\emdef{Norm}, wenn für alle $v,w\in V$ und $a\in\mathbb K$
die drei Axiome%
\begin{gather}
\|v\|=0 \implies v=0,\\
\|av\| = |a|\,\|v\|,\\
...
Für linear unabhängige Vektoren $w_1,\ldots,w_n$
wird durch%
\begin{equation}
v_k := w_k - \sum_{i=1}^{k-1} P[v_i](w_k)
\end{equation}
ein Orthogonalsystem $v_1,\ldots,v_n$ berechnet.

Speziell für zwei nicht kollineare Vektoren $w_1,w_2$ gilt
\begin{gather}
v_1=w_1,\\
v_2=w_2-P[v_1](w_2).
\end{gather}
