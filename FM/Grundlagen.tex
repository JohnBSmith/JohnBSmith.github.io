...
und $g\colon B\to C$ ist die \emdef{Komposition} ($g$ nach $f$)
durch
\begin{equation}
...
\end{equation}
\emdef{Iteration} von $\varphi$ genannt.
\end{Definition}
\begin{Definition}
...
\end{equation}
\emdef{Kompositionsoperator} genannt
\end{Definition}
...
\begin{tabular}{l||l}
\bsf{EANIK | EA | D} & Ring\\
\bsf{EANIK | EAK | D} & kommutativer Ring\\
\bsf{EANIK | EAN | D} & unitärer Ring\\
